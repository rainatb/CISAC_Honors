# rerunning bootstrapping for first 10 iterations
...
# change iterations
write.csv(auc_per_run, 'data/auc_for_vars_Jan2025_1_10_its')
write.csv(feature_importance_optimal_model, 'data/feature_importance_for_vars_Jan2025its_1_10.csv')
write.csv(pdps_optimal_model, 'data/pdp_for_vars_Jan2025_its_1_10.csv')
