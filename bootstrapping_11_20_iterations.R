# rerunning bootstrapping for iterations 11-20
...
# change iterations
write.csv(auc_per_run, 'data/auc_for_vars_Jan2025_11_20_its')
write.csv(feature_importance_optimal_model, 'data/feature_importance_for_vars_Jan2025its_11_20.csv')
write.csv(pdps_optimal_model, 'data/pdp_for_vars_Jan2025_its_11_20.csv')
